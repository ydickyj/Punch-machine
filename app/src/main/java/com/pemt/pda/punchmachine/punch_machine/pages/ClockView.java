package com.pemt.pda.punchmachine.punch_machine.pages;
...
public class ClockView extends View {
    ...
    public ClockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        text_size = ta.getDimension(R.styleable.clock_text_size, 30);//表盘中文字大小
        radius_center = ta.getDimension(R.styleable.clock_radius_center, 10);//表盘正中心的半径长度 radius_center
        width_hour = ta.getDimension(R.styleable.clock_width_hour, 15);//时针宽度
        width_minutes = ta.getDimension(R.styleable.clock_density_minute, 8);//分针刻度宽度
        width_second = ta.getDimension(R.styleable.clock_density_second, 4);//秒针刻度宽度
...
//        paintCircle.setStyle(Paint.Style.STROKE);
        paintCircle.setColor(getResources().getColor(R.color.clockBackground));
...
//        }
        ...
        painDegree.setColor(Color.WHITE);
        ...
        float startY = mHeight / 2 - mWidth / 2 + 40;
        ...
        paintSecond.setColor(getResources().getColor(R.color.paintSecond));
